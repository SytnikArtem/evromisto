...
(function ($){
  $(document).ready(function() {
    ...
    function initMap() {
      var evromisto = {lat: 50.377244, lng: 30.379595};
      ...
      var icon = {
        url: window.location.origin + '/wp-content/uploads/2017/03/centerPin.png',
      ...
      function calculateAndDisplayOwnRoute(directionsService, directionsDisplay, destination, location) {
        directionsService.route({
          origin: {lat: 50.377244, lng: 30.378819},
      ...
      function makeOwnMarker( position ) {
        ...
        var destOwnMarker = new MarkerWithLabel({
          ...
          labelClass: "start-marker-label", // the CSS class for the label
          labelInBackground: false,
          icon: ' '
        });

        markersToRemove.push(destOwnMarker); // markersToRemove is a global array
      }
      ...
      function makeMarker( position, location ) {
        ...
        markersToRemove.push(destMarker); // markersToRemove is a global array
